...
//Including top_im file
        ...
        <div class="page-content-wrapper" >
            <div class="page-content" >
                <div class="row">
                    <div class="col-md-12">
                        <h3 class="page-title row-br-b-wp">Product Wise Stock Status – District Stores</h3>
                    </div>
                </div>
                <div class="row" >
                    <div class="col-md-12" >
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="form-group ">
                                                            <select name="prov_sel" id="prov_sel" required class="form-control input-sm">
                                                                ...
                                                                <?php
                                                                        $prov = "Select * from tbl_locations where PkLocID = '" . $_SESSION['user_province'] . "'";
                                                                         $qryRes = mysql_query($prov);
