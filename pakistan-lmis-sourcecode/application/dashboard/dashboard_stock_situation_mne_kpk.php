...
if (!empty($dist_arr_request)) {
    $dist = implode(',', $dist_arr_request);
}
//    $where = '';
//    $where_itm = '';
                                                            ...
                                                            <select name="district[]" id="district" class="multiselect-ui form-control input-sm" multiple>
                                                                ...
                                                                while ($rowDist = mysql_fetch_array($rsDist)) {
                                                                    if (!isset($_REQUEST['district'])) {
                                                                        if ($rowDist['PkLocID'] == 14 || $rowDist['PkLocID'] == 77 || $rowDist['PkLocID'] == 149 || $rowDist['PkLocID'] == 93) {
                    ...
                    <div class="row">
                        <div class="col-md-4 my_dash_cols">
                            <div class="col-md-12 my_dashlets">
                                <div class="dashlet_graph" id="dashboard_stock_a1" href='dashboard_stock_a1_mne_kpk.php'></div>
                            </div>

                            <div class="col-md-12 my_dashlets">
                                <div class="dashlet_graph" id="dashboard_stock_a4" href='dashboard_stock_a4_mne_kpk.php'></div>
                            </div>
                        ...
                        <div class="col-md-4 my_dash_cols">
                            <div class="col-md-12 my_dashlets"  >
                                <div class="dashlet_graph" id="dashboard_stock_a2" href='dashboard_stock_a2_mne_kpk.php'></div>
                            </div>

                            <div class="col-md-12 my_dashlets">
                                <div class="dashlet_graph" id="dashboard_stock_a5" href='dashboard_stock_a5_mne_kpk.php'></div>
                            </div>
                        ...
                        <div class="col-md-4 my_dash_cols">
                            ...
                            <div class="col-md-12 my_dashlets">
                                <div class="dashlet_graph" id="dashboard_stock_a3" href='dashboard_stock_a3_mne_kpk.php'></div>
                            </div>
                            <div class="col-md-12 my_dashlets"  >
                                <div class="dashlet_graph" id="dashboard_stock_a6" href='dashboard_stock_a6_mne_kpk.php'></div>
                            </div>
                        </div>
                    </div>
...
//Including footer file
    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            $.ajax({
                type: "POST",
                url: '<?php echo APP_URL; ?>dashboard/dashboard_stock_top_bar_mne_kpk.php',
                data: $('form').serialize(),
                dataType: 'html',
