...
//Checking Do
                if (isset($_REQUEST['Do']) && !empty($_REQUEST['Do'])) {
                    ...
                    $ecr_data_open_since = $qryLvl['ecr_data_open_since'];
//                    echo '<pre>';
//                    print_r($qryLvl);
//                    echo '</pre>';
//                    exit;
                            ...
                            <div class="col-md-12">
                                ...
                                <table class="table table-bordered">
                                    <tr>
                                        ...
                                        <th <?php echo $rowcolspan; ?> class="text-center">Received (From District Store)</th>
                                        <th rowspan="2" class="text-center">Issued<?php if ($is_ecr) echo '<br/> (Auto Fetched from ECR)'; ?> (To Client for Consumption)</th>
                                        ...
                                        <?php
                                        if($_SESSION['user_stakeholder1']!='3421'){
                                        ?>
...
<?php
                ...
                ?>                                                    
                                                    ...
                                                    <td><input class="form-control input-sm text-right" autocomplete="off" type="text" readonly="readonly" name="FLDCBLA<?php echo $rsRow1['itm_id']; ?>" id="FLDCBLA<?php echo $rsRow1['itm_id']; ?>" size="8" maxlength="10" value="<?php echo $cb_a; ?>" ></td>
                ...
                ?>
                                                    ...
                                                    <td><input class="form-control input-sm text-right" autocomplete="off"  type="text" readonly="readonly" name="FLDCBLA<?php echo $rsRow1['itm_id']; ?>" id="FLDCBLA<?php echo $rsRow1['itm_id']; ?>" size="8" maxlength="10" value="<?php echo $rsRow2['closing_balance']; ?>"  ></td>
                    ...
                    success: function(html){
                        ...
                        setTimeout(location.reload.bind(location), 2000);
                                        ...
                                        function formvalidate1()
                                        {
                                            ...
                                            $.ajax({
                                                url: 'data_entry_hf_ngo_action.php',
                                                data: $('#frmF7').serialize(),
                                                type: 'POST',
                                                dataType: 'json',
