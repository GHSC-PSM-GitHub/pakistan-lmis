...
//////// jira: LMIS-1983, request from punjab pwd to lock permanently the columns of adjustment in consumption data entry
$show_adj = true;
if ($_SESSION['user_province1'] == '1' && $_SESSION['user_stakeholder1'] == '1') {
    // Health Facility Adjustments unlocked on request of PWD Punjab. Reference jira ticket ID: LMIS-3330
                            ...
                            <div class="col-md-12">
                                ...
                                <table class="table table-bordered">
                                    <tr>
                                        ...
                                        <th colspan="2" class="text-center">Change of Method</th>
                                        <th rowspan="2" class="text-center">Removals</th>
                                        <th rowspan="2" class="text-center">Dropouts</th>
                                        <th rowspan="2" class="text-center">Retrieved</th>
                                    ...
                                    while ($rsRow1 = mysql_fetch_array($rsTemp1)) {
                                        if ((isset($hfTypeId) && $hfTypeId == 1) && (isset($result_province['prov_id']) && $result_province['prov_id'] == 1)) {
                                            if (in_array($rsRow1['itm_id'], array(8, 13, 30, 81)))
                                                continue;
                                        }
...
WHERE
	stock_sources_data.hf_data_id = '$hf_data_id'";
                                        ...
                                        //for reverse logistic adjustment
                                        $qryadj = "SELECT
                                                        stock_batch.wh_id,
                                                        stock_batch.batch_id,
                                                        stock_batch.batch_no,
                                                    ...
                                                    WHERE
                                                        ...
                                                        tbl_stock_detail.IsReceived = 0 AND
                                                          DATE_FORMAT(tbl_stock_master.TranDate,'%Y-%m') = '$yy-$mm'
                                                               AND tbl_stock_master.TranTypeID = 30 
                                        ...
                                        //result
//                                        echo $qryadj;exit;
                                        $rev = mysql_query($qryadj);
                                        $rev_array = array();
                                        while ($rsRowrev = mysql_fetch_array($rev)) {
                                            $rev_array[$rsRowrev['item_id']] = $rsRowrev['Qty'];
                                        }
                                        ...
                                        if ($isNewRpt == 1) {
                                            ...
                                            if ($rsRow1['itm_category'] == 1) {
                                                ...
                                                $wh_adja = 0;
                                                //wh_adjb
                                                $wh_adjb = ((!empty($rev_array[$rsRow1['itm_id']])) ? $rev_array[$rsRow1['itm_id']] : '0');
                                                //wh_received
                                    ...
                                    if ($key == 130 || $key == 216) {
                                        ...
                                        $sdf = $wh_received;
                                                    ...
                                                    <td><input <?= ($show_adj) ? '' : 'readonly' ?> class="form-control input-sm text-right" autocomplete="off" type="text" name="FLDReturnTo<?php echo $rsRow1['itm_id']; ?>" id="FLDReturnTo<?php echo $rsRow1['itm_id']; ?>" size="8" maxlength="10" value="<?php echo $wh_adja; ?>" onKeyUp="cal_balance('<?php echo $rsRow1['itm_id']; ?>');"></td>
                                                    <td><input <?= ($show_adj) ? '' : 'readonly' ?> class="form-control input-sm text-right" autocomplete="off" type="text" name="FLDUnusable<?php echo $rsRow1['itm_id']; ?>" id="FLDUnusable<?php echo $rsRow1['itm_id']; ?>" size="8" maxlength="10" value="<?php echo $wh_adjb; ?>" onKeyUp="cal_balance('<?php echo $rsRow1['itm_id']; ?>');"></td>
                                                    ...
                                                    <td><input class="form-control input-sm text-right" autocomplete="off" type="text" name="Change_pos<?php echo $rsRow1['itm_id']; ?>" id="Change_pos<?php echo $rsRow1['itm_id']; ?>" size="8" maxlength="10"  value="<?php echo $change_pos; ?>"></td>
                                                    <td><input class="form-control input-sm text-right" autocomplete="off" type="text" name="Change_neg<?php echo $rsRow1['itm_id']; ?>" id="Change_neg<?php echo $rsRow1['itm_id']; ?>" size="8" maxlength="10"  value="<?php echo $change_neg; ?>"></td>
                                                    ...
                                                    <td><input class="form-control input-sm text-right" autocomplete="off" type="text" name="Retrieved<?php echo $rsRow1['itm_id']; ?>" id="Retrieved<?php echo $rsRow1['itm_id']; ?>" size="8" maxlength="10"  value="<?php echo $retrieved; ?>"></td>
                ...
                foreach ($sources as $key => $rowsrc) {
                    ...
                    ?>
                                                        ...
                                                        if ($_SESSION['user_province'] == 1 && $_SESSION['user_stakeholder'] == 1) {
                                                             $rsRow2['adjustment_negative'] = ((!empty($rev_array[$rsRow1['itm_id']])) ? $rev_array[$rsRow1['itm_id']] : '0'); 
                                                             
                                                        }
                                                        
                                                        $rsRow2['closing_balance'] = $rsRow2['opening_balance'] + $rsRow2['received_balance']-$rsRow2['issue_balance']+$rsRow2['adjustment_positive']-$rsRow2['adjustment_negative'];
                                                               ?>
                                                    ...
                                                    <td><input <?= ($show_adj) ? '' : 'readonly' ?> class="form-control input-sm text-right" autocomplete="off"  type="text" name="FLDReturnTo<?php echo $rsRow1['itm_id']; ?>" id="FLDReturnTo<?php echo $rsRow1['itm_id']; ?>" size="8" maxlength="10" value="<?php echo $rsRow2['adjustment_positive']; ?>" onKeyUp="cal_balance('<?php echo $rsRow1['itm_id']; ?>');"></td>
                                                    <td><input <?= ($show_adj) ? '' : 'readonly' ?> class="form-control input-sm text-right" autocomplete="off"  type="text" name="FLDUnusable<?php echo $rsRow1['itm_id']; ?>" id="FLDUnusable<?php echo $rsRow1['itm_id']; ?>" size="8" maxlength="10" value="<?php echo $rsRow2['adjustment_negative']; ?>" onKeyUp="cal_balance('<?php echo $rsRow1['itm_id']; ?>');"></td>
                                                    ...
                                                    <td><input class="form-control input-sm text-right" autocomplete="off"  type="text" name="Change_pos<?php echo $rsRow1['itm_id']; ?>" id="Change_pos<?php echo $rsRow1['itm_id']; ?>" size="8" maxlength="10"  value="<?php echo $rsRow2['change_pos']; ?>"></td>
                                                    <td><input class="form-control input-sm text-right" autocomplete="off"  type="text" name="Change_neg<?php echo $rsRow1['itm_id']; ?>" id="Change_neg<?php echo $rsRow1['itm_id']; ?>" size="8" maxlength="10"  value="<?php echo $rsRow2['change_neg']; ?>"></td>
                                                    ...
                                                    <td><input class="form-control input-sm text-right" autocomplete="off"  type="text" name="Retrieved<?php echo $rsRow1['itm_id']; ?>" id="Retrieved<?php echo $rsRow1['itm_id']; ?>" size="8" maxlength="10"  value="<?php echo $rsRow2['retrieved']; ?>"></td>
    ...
    <script language="javascript" type="text/javascript">
                                        ...
                                        function formvalidate1()
                                        {
                                            ...
                                            $.ajax({
                                                url: 'data_entry_hf_pwd_new_action.php',
                                                data: $('#frmF7').serialize(),
                                                type: 'POST',
                                                dataType: 'json',
