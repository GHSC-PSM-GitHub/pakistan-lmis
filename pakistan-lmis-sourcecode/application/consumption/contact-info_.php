...
if (isset($_REQUEST['submit']) && !empty($_REQUEST['submit'])) {
    ...
    if ($button == 'contact') {
        ...
        $sysusr_name = mysql_real_escape_string($sysusr_name);
        $sysusr_deg = $_POST['office'];
        $sysusr_deg = mysql_real_escape_string($sysusr_deg);
        $sysusr_email = $_POST['email'];
        $sysusr_email = mysql_real_escape_string($sysusr_email);
        $sysusr_dept = $_POST['department'];
        $sysusr_dept = mysql_real_escape_string($sysusr_dept);
        $sysusr_cell = $_POST['cellnumber'];
        $sysusr_cell = mysql_real_escape_string($sysusr_cell);
