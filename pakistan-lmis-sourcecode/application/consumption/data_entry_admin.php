	...
	function showMonths(wharehouse_id)
	{
		$.ajax({
			...
			success: function(data) {
				...
				if (data.TotalHF > 0 && data.StoreLevel == 7)
				{
					if (data.Stakeholder == 1 || data.Stakeholder == 3190) {
						dataEntryURL = 'data_entry_hf_pwd.php';
					} else {
						dataEntryURL = 'data_entry_hf.php';
					}
                    ...
                    <div class="col-md-12">
                        <div class="widget">
                            <div class="widget-head">
                                <h3 class="heading">Data Entry for Facility & District Stores  </h3>
                            </div>
                            <div class="widget-body">
                                <h4 class="heading">Select the relevant Facility Name / District Store to Add/Edit data.</h4>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="col-md-2">
                                                            ...
                                                            <select name="stk_sel" id="stk_sel" class="form-control input-sm" required="required">
                                                                ...
                                                                <?php
                                                                if(empty($arr['stk']))$arr['stk'][]= $_SESSION['user_stakeholder1'];
                                                        ...
                                                        <td class="col-md-2">
                                                            <?php
                                                           if(empty($arr['prov']))$arr['prov'][]= $_SESSION['user_province1'];
                                                            $qry = "SELECT
