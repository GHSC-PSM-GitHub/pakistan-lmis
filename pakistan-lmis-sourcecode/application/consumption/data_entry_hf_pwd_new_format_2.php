...
if ($_SESSION['is_allowed_im'] == 1 && $RptDate >= $_SESSION['im_start_month'] && $_SESSION['user_role'] != 2) {
...
//                    echo $q_wh;
//                    exit;
                    $qryLvl = mysql_fetch_array(mysql_query($q_wh));
                    $hfTypeId = $qryLvl['hf_type_id'];
                    $whProvId = $qryLvl['prov_id'];
                    $wh_lvl = $qryLvl['lvl'];
                    $ecr_start_month = $qryLvl['ecr_start_month'];

                    $is_ecr = false;
                    if (!empty($ecr_start_month) && $ecr_start_month != '' && $RptDate >= $ecr_start_month) {
                        $is_ecr = true;
                    }
...
//month
                    ...
                    echo "<h3 class=\"page-title row-br-b-wp\">" . $whName . " <span class=\"green-clr-txt\">(" . $month . ' ' . $yy . ")</span>";
                    if ($is_ecr) {
                        echo ' &nbsp;<a class="badge badge-warning"> ECR Module is Enabled for this facility since ' . date('d-M-Y', strtotime($ecr_start_month)) . '</a>';
                        echo '<a class="btn btn-xs btn-success pull-right"  id="reload_ecr_data"><i class="fa fa-refresh"></i> Reload ECR Data</a>';
                        echo '<span id="reload_msg"></span>';
                    }
                    echo "</h3>";
                                    ...
                                    <div class="portlet-body">
                                        <table class="table table-condensed table-bordered">
                                            <tr>
                                                ...
                                                <th rowspan="2" class="text-center">Issued<?php if ($is_ecr) echo '<br/> (Auto Fetched from ECR)'; ?></th>
                                                ...
                                                <?php
                                                if ($hfTypeId == 1 || $hfTypeId == 4 || $hfTypeId == 5 || $hfTypeId == 130) {
                                                    ?>
	...
	stock_sources_data.hf_data_id = '$hf_data_id'";
                                                ...
                                                if ($isNewRpt == 1) {
                                                    ...
                                                    if ($rsRow1['itm_category'] == 1) {
                                                        ...
                                                        if ($is_ecr) {
                                                            ///// for ECR overriding the current months data

                                                            $qry7 = "SELECT issue_balance FROM tbl_hf_data WHERE `warehouse_id`='" . $wh_id . "' AND reporting_date='" . $RptDate . "' AND `item_id`='$rsRow1[itm_id]'";
                                                            //result
                                                            //                                                        echo $qry7;exit;
                                                            $rsTemp7 = mysql_query($qry7);
                                                            $rs_row7 = mysql_fetch_array($rsTemp7);
                                                            $wh_issue_up = $rs_row7['issue_balance'];

                                                            $cb_a = $wh_received - $wh_issue_up + $rsRow2['closing_balance'];
                                                        }
                                                        ?>
                                                        <tr>
                                            ...
                                            if ($key == 130 || $key == 216) {
                                                ...
                                                $sdf = $wh_received;
                                                            ...
                                                            <td><input class="form-control input-sm text-right" autocomplete="off" name="FLDIsuueUP<?php echo $rsRow1['itm_id']; ?>" id="FLDIsuueUP<?php echo $rsRow1['itm_id']; ?>" value="<?php echo $wh_issue_up; ?>" type="text"  size="8" maxlength="10" onKeyUp="cal_balance('<?php echo $rsRow1['itm_id']; ?>');" <?php if ($is_ecr) echo 'readonly="readonly"'; ?>></td>
                                            ...
                                            if ($key == 130 || $key == 216) {
                                                ...
                                                if ($readonly_for_im) {
                                                    ...
                                                    $rsRow2['received_balance'] = $this_value;
                                                            ...
                                                            <td><input class="form-control input-sm text-right" autocomplete="off" name="FLDIsuueUP<?php echo $rsRow1['itm_id']; ?>" id="FLDIsuueUP<?php echo $rsRow1['itm_id']; ?>" value="<?php echo $rsRow2['issue_balance']; ?>" type="text" size="8" maxlength="10" onKeyUp="cal_balance('<?php echo $rsRow1['itm_id']; ?>');"  <?php if ($is_ecr) echo 'readonly="readonly"'; ?>></td>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <?php
                                if ($hfTypeId == 4 || $hfTypeId == 5 || $hfTypeId == 130) {
                                    //start RHSA or RHSB
                                    ?>
                                    <div class="col-md-8">
                                                ...
                                                <div class="portlet-body">
                                                    ...
                                                    <table class="table table-condensed  table-bordered">
                                                        <tr>
                                                            ...
                                                            //check hfTypeId 
                                                            if ($hfTypeId == 4) {
                                                                $and = " AND tbl_hf_type.pk_id not in (5,130) ";
                                                            } else if ($hfTypeId == 5) {
                                                                $and = " AND tbl_hf_type.pk_id not in (4,130) ";
                                                            }
                                                            //query
                                                            //gets
                                                            //tbl_hf_type.pk_id,
...
//                                                echo '<prE>xxx';print_r($imp_arr);print_r($hf_t_arr);exit;
                ...
                <div class="portlet box green-meadow">
                    ...
                    <div class="portlet-body">
                        ...
                        $iQry = "SELECT
                                    ...
                                    remarks.module = 'consumption_data_entry' ";
                        $rsss = mysql_query($iQry);
                        $r_c = 0;
    ...
    <script language="javascript" type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $('#reload_ecr_data').click(function (e) {
                $("#reload_msg").html('Reloading...');
                $.ajax({
                    url: "../ecr/aggregate_data.php?ajax=yes&month=<?php echo $yy . '-' . $mm ?>-01&wh_id=<?php echo $wh_id; ?>" ,
                    cache: false,
                    success: function(html){
                        $("#reload_msg").html(''+html+'. Now refreshing the screen...');
        ...
        function formvalidate1()
        {
            ...
            $.ajax({
                url: 'data_entry_hf_pwd_new_2_action.php',
                data: $('#frmF7').serialize(),
                type: 'POST',
                dataType: 'json',
                success: function (data) {
                    ...
                    if (data.resp == 'err')
                    {
                        ...
                        /// manually triggering keyup func to calculate closing balance based on data
                        $('#FLDRecv1').trigger('keyup');
                        $('#FLDRecv2').trigger('keyup');
                        $('#FLDRecv3').trigger('keyup');
                        $('#FLDRecv5').trigger('keyup');
                        $('#FLDRecv7').trigger('keyup');
                        $('#FLDRecv8').trigger('keyup');
                        $('#FLDRecv9').trigger('keyup');
                        $('#FLDRecv13').trigger('keyup');
                        $('#FLDRecv34').trigger('keyup');
                        $('#FLDRecv81').trigger('keyup');
                        $('#saveBtn').attr('disabled', false);
                        $('#eMsg').hide('Try Again, after verifying balances');
