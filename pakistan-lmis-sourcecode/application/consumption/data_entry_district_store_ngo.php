...
<link href="<?php echo PUBLIC_URL; ?>css/styles.css" rel="stylesheet" type="text/css"/>
        ...
        <div class="page-content-wrapper">
            <div class="page-content" style="margin-left:0px !important">
                ...
                if (isset($_REQUEST['Do']) && !empty($_REQUEST['Do'])) {
                    ...
                    // Stakeholder 6 = MSS
                    // Stakeholder 9 = PPHI
                    if ($qryLvl['lvl'] == 4 || $_SESSION['user_stakeholder1'] == 6 || $_SESSION['user_stakeholder1'] == 9 || $yy <= 2017) {
                        $readonly = '';
                    } else {
                        $readonly = " ";
                    }
    ...
    if($_SESSION['user_role'] == 77) {
        $rsTemp1 = mysql_query("SELECT * FROM `itminfo_tab` WHERE `itm_status`=1 AND `itm_id` IN (SELECT `Stk_item` FROM `stakeholder_item` WHERE `stkid` =$stkid) AND itminfo_tab.itm_category = 12 ORDER BY `frmindex`");
    } else if($_SESSION['user_warehouse'] == 5621) {
        $rsTemp1 = mysql_query("SELECT * FROM `itminfo_tab` WHERE `itm_status`=1 AND `itm_id` IN (SELECT `Stk_item` FROM `stakeholder_item` WHERE `stkid` =$stkid) AND itminfo_tab.itm_category IN (1,4) ORDER BY `frmindex`");
    } else {
        $rsTemp1 = mysql_query("SELECT * FROM `itminfo_tab` WHERE `itm_status`=1 AND `itm_id` IN (SELECT `Stk_item` FROM `stakeholder_item` WHERE `stkid` =$stkid) AND itminfo_tab.itm_category = 1 ORDER BY `frmindex`");
    }
...
<?php echo $rsRow1['itm_name']; ?>
                ...
                <td><input class="form-control input-sm text-right"  autocomplete="off"  type="text" name="FLDOBLA<?php echo $itemid[1]; ?>" id="FLDOBLA<?php echo $itemid[1]; ?>" size="8" maxlength="10" value="<?php echo $ob_a; ?>" onKeyUp="cal_balance('<?php echo $itemid[1]; ?>');"></td>
                <td><input class="form-control input-sm text-right"   autocomplete="off"  type="text" name="FLDRecv<?php echo $itemid[1]; ?>" id="FLDRecv<?php echo $itemid[1]; ?>" size="8" maxlength="10"  value="<?php echo $wh_received; ?>" onKeyUp="cal_balance('<?php echo $itemid[1]; ?>');"  ></td>
                ...
                <td><input class="form-control input-sm text-right" autocomplete="off" type="text" name="FLDCBLA<?php echo $itemid[1]; ?>" id="FLDCBLA<?php echo $itemid[1]; ?>" size="8" maxlength="10" value="<?php echo $cb_a; ?>"  ></td>
                <td><textarea class="form-control" rows="1" name="FLDCMNTS<?php echo $itemid[1]; ?>" id="FLDCMNTS<?php echo $itemid[1]; ?>"><?php echo $cmnts; ?></textarea></td>
            </tr>
            <?php
        }
        // If oone of the 3 months
            ...
            ?>
                <tr>
                    ...
                    <td><input class="form-control input-sm text-right"  autocomplete="off"  type="text" name="FLDOBLA<?php echo $itemid[1]; ?>" id="FLDOBLA<?php echo $itemid[1]; ?>" size="8" maxlength="10" value="<?php echo $rsRow2['wh_obl_a']; ?>" onKeyUp="cal_balance('<?php echo $itemid[1]; ?>');"></td>
                    <td><input class="form-control input-sm text-right" autocomplete="off"  type="text" name="FLDRecv<?php echo $itemid[1]; ?>" id="FLDRecv<?php echo $itemid[1]; ?>" size="8" maxlength="10"  value="<?php echo $rsRow2['wh_received']; ?>" onKeyUp="cal_balance('<?php echo $itemid[1]; ?>');" <?php echo $readonly; ?>></td>
                    ...
                    <td><input class="form-control input-sm text-right" autocomplete="off"  type="text" name="FLDCBLA<?php echo $itemid[1]; ?>" id="FLDCBLA<?php echo $itemid[1]; ?>" size="8" maxlength="10" value="<?php echo $rsRow2['wh_cbl_a']; ?>"  ></td>
                    <td><textarea class="form-control" rows="1" name="FLDCMNTS<?php echo $itemid[1]; ?>" id="FLDCMNTS<?php echo $itemid[1]; ?>"><?php echo $rsRow2['comments']; ?></textarea></td>
                </tr>
            <?php
        }
        ?>
