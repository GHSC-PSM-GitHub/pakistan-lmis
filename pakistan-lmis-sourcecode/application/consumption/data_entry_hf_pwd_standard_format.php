                            ...
                            <div class="col-md-12">
                                ...
                                <table class="table table-bordered">
                                    ...
                                    while ($rsRow1 = mysql_fetch_array($rsTemp1)) {
                                        ...
                                        if((isset($result_province['prov_id']) && !($result_province['prov_id'] == 2 || $result_province['prov_id'] == 3 || $result_province['prov_id'] == 4))){//balochistan included on the request of hashim PWD
...
WHERE
    ...
    <script language="javascript" type="text/javascript">
                                    ...
                                    function formvalidate1()
                                    {
                                        ...
                                        $.ajax({
                                            url: 'data_entry_hf_pwd_standard_action.php',
                                            data: $('#frmF7').serialize(),
                                            type: 'POST',
                                            dataType: 'json',
