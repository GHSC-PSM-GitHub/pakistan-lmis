                        ...
                        <div class="widget">
                            ...
                            <div class="widget-body">
                                <form name="frm" id="frm" action="import_action.php" method="post" enctype="multipart/form-data">
                                    <div class="row">
                                        <div class="col-md-12"> To upload data in cLMIS, please download the sample file from the link below. 
                                            <br/>Then enter your data 'Only in Relevant Columns'. 
                                            <br/>Please do NOT change any thing else. Please do NOT rename columns or IDs. Please do NOT change order of columns.
                                            <br/>Then upload the file using the button given below. </div>
                                    </div>
                                    <div class="row">
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <div class="col-md-3">
                                                <div class="control-group">
                                                    ...
                                                    <div class="controls">
                                                        <?php
                                                        if ($_SESSION['user_id'] == 10406 || $_SESSION['user_id'] == 2006) {// this is only allowed to abdul_samad and husnain(greenstar)
                                                            echo '<button type="submit" name="submit" value="submit" class="btn btn-primary" onclick="return confirm(\'Are you sure you want to upload this data? This step is not reversible !\')">Import</button>';
                                                        } else {
                                                            echo '<p>You Cannot Access This Option.</br>Write to support@lmis.gov.pk for any query</p>';
                                                        }
                                                        ?>
                                                    </div>
                                                    <!-- <div class="controls">
