...
<script>
    ...
    function doInitGrid() {
        ...
        mygrid.setHeader("<div style='text-align:center; font-size:14px; font-weight:bold;'>Monthly <?php echo $strTitle; ?> Report for <?php echo $qryRes['wh_name']; ?> (<?php echo date('d-M-Y', strtotime($from_date)); ?> to <?php echo date('d-M-Y', strtotime($to_date)); ?> )</div>,#cspan,#cspan,#cspan,#cspan,#cspan,#cspan<?php echo $colspan; ?>,#cspan,#cspan,#cspan");
        mygrid.attachHeader("<div style='text-align:center;'>Product</div>,<div style='text-align:center;'>Generic Name</div>,<div style='text-align:center;'>Batch No</span>,<div style='text-align:center;'>Opening Balance</span>,<span title='Balance received'>Received</span>,<span title='Balance issued'>Issued</span>,<div style='text-align:center;'>Adjustments</div>,#cspan,<span title='Closing balance'>Closing Balance</span><?php echo $header; ?>,<span title='Last Modified'>Last Modified</span>");
        mygrid.attachHeader("#rspan,#rspan,#rspan,#rspan,#rspan,#rspan,<div style='text-align:center;'>(+)</div>,<div style='text-align:center;'>(-)</div>,#rspan<?php echo $header1; ?>,#rspan");
...
<?php } ?>
        ...
        mygrid.setColAlign("left,left,left,right,right,right,right,right,right<?php echo $colAlign; ?>,center");
        mygrid.setColTypes("ro,ro,ro,ro,ro,ro,ro,ro,ro<?php echo $colType; ?>,ro");
...
WHERE
	...
	AND tbl_warehouse.prov_id = 3";
                                                                    ...
                                                                    while ($rowprov = mysql_fetch_array($rsprov)) {
                                                                        if ($_POST['funding_source'] == $rowprov['wh_id']) {
                                                    ...
                                                    <div class="col-md-3">
                                                        <div class="control-group">
                                                            ...
                                                            <div class="controls">
                                                                <select name="wh_id" id="wh_id" class="input-medium select2me" required="required">
...
//Get warehouse user By Idc
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        ?>
                        <br/>
                        <span class="note note-info">NOTE: This report shows data of only those stores / facilities which are individually assigned to the user !</span>
                    </div>
                </div>
            </div>
        </div>
