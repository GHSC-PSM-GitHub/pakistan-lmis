...
if (isset($_REQUEST['month_sel']) || isset($_REQUEST['lvl_type'])) {
    ...
    if ($sel_district != '' && $sel_district != 'all') {
        //set district filter
			...
			WHERE
				tbl_warehouse.wh_id NOT IN (
					...
					$stk_filter
                                ...
                                AND tbl_warehouse.reporting_start_month <= '$sel_year-$sel_month-01'
...
//include top_im
    ...
    <script>
        ...
        function doInitGrid() {
            ...
            mygrid.setHeader("<div style='text-align:center;'><?php echo "$report_title Stakeholder = $stakeholderName And Province/Region = $provinceName (" . date('F', mktime(0, 0, 0, $sel_month)) . ' ' . $sel_year . ")"; ?></div>,#cspan,#cspan,#cspan,#cspan,#cspan,#cspan,#cspan,#cspan,#cspan");
            mygrid.attachHeader("S. No., Province/Region, District, Stakeholder, Warehouse/Store Type, Warehouse/Store Name, Last Updated,History, IP Address, Status");
            mygrid.attachHeader(",#select_filter,#select_filter,#select_filter,#select_filter,,,,,");
            mygrid.attachFooter("<div style='text-align:center; font-size:14px; font-weight:bold; font-family:Helvetica'>Late reporting means reported after 15th of the reporting month</div>,#cspan,#cspan,#cspan,#cspan,#cspan,#cspan,#cspan,#cspan,#cspan");
            ...
            mygrid.setInitWidths("20,120,110,60,150,*,150,50,100,70");
