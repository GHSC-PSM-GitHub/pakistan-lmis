                        ...
                        <tr>
                                        ...
                                        <?php
                                                    ...
                                                    foreach ($districtName as $id => $name) {
														...
														$qry_dist = "SELECT
	                                                                    ...
	                                                                    DATE_FORMAT( tbl_wh_data.RptDate, '%Y-%m' ) As RptDate
																	FROM
																		tbl_wh_data
							...
							//if result exists
                                                        ...
                                                        if (mysql_num_rows($qryRes_dist) > 0) {
                                                            while ($row_dist = mysql_fetch_array($qryRes_dist)) {
                                                                if ($fromDate == $row_dist['RptDate']){
                                        ...
                                        <tr>
                                            ...
                                            <?php
                                                            ...
                                                            $district_total_html .= "<td class=\"right\">" . number_format((isset($CBDistStore)?$CBDistStore:'0')) . "</td>";
                                        ...
                                        <tr>
                                            ...
                                            <?php
                                                            ...
                                                            foreach ($hfType as $id => $name) {
                                                                ...
                                                                $receive += (isset($data[$id]['Rcv'])?$data[$id]['Rcv']:'0');
                                                                $issue += (isset($data[$id]['Issue'])?$data[$id]['Issue']:'0');
                                                                $closing += (isset($data[$id]['CB'])?$data[$id]['CB']:'0');
                                                                $gtotal_facilities .= "<th class=\"right\">" . number_format((isset($data[$id]['OB'])?$data[$id]['OB']:'0')) . "</th>";
                                                                $gtotal_facilities .= "<th class=\"right\">" . number_format((isset($data[$id]['Rcv'])?$data[$id]['Rcv']:'0')) . "</th>";
                                                                $gtotal_facilities .= "<th class=\"right\">" . number_format((isset($data[$id]['Issue'])?$data[$id]['Issue']:'0')) . "</th>";
                                                                $gtotal_facilities .= "<th class=\"right\">" . number_format((isset($data[$id]['CB'])?$data[$id]['CB']:'0')) . "</th>";
                                                            }
