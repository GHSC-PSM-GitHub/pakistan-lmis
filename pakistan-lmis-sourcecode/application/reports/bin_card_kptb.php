...
<script>
    ...
    function doInitGrid() {
        ...
        mygrid.setHeader("<div style='text-align:center; font-size:14px; font-weight:bold;'>Monthly <?php echo $strTitle; ?> Report for <?php echo $qryRes['wh_name']; ?> (<?php echo date('d-M-Y', strtotime($from_date)); ?> to <?php echo date('d-M-Y', strtotime($to_date)); ?> )</div>,#cspan,#cspan,#cspan,#cspan,#cspan,#cspan,#cspan,#cspan,#cspan,#cspan<?php echo $colspan; ?>,#cspan,#cspan,#cspan");
        mygrid.attachHeader("<div style='text-align:center;'>Date</div>,<div style='text-align:center;'>Name Of Drug</div>,<div style='text-align:center;'>Received From</div>,<div style='text-align:center;'>Issued To</div>,<div style='text-align:center;'>Batch No</div>,<div style='text-align:center;'>Expiry Date</div>,<div style='text-align:center;'>Shelf Life</div>,<div style='text-align:center;'>Opening Balance</span>,<span title='Quantity Received'>Quantity Received</span>,<span title='Quantity Issued'>Quantity Issued</span>,<div style='text-align:center;'>Adjustments</div>,#cspan,<span title='Balance'>Balance</span><?php echo $header; ?>,<span title='Last Modified'>Last Modified</span>");
...
<?php } ?>
        mygrid.setInitWidths("*,120,120,100,100,100,60,60,120<?php echo $width; ?>,120");
        mygrid.setColAlign("left,left,left,right,right,right,right,right,right,right<?php echo $colAlign; ?>,center");
    ...
    <div class="page-container">
        ...
        <div class="page-content-wrapper">
            <div class="page-content">
                <div class="row">
                    <div class="col-md-12">
                        <h3 class="page-title row-br-b-wp">Bin Card Report KPTB</h3>
