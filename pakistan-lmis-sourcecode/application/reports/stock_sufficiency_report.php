...
if (isset($_POST['submit'])) {
    ...
    if ($_POST['district'] != 'all') {
        $selDist = " AND tbl_locations.PkLocID = ".mysql_real_escape_string($_POST['district'])." ";
    }else{
        $selDist = '';
    }
...
?>
        <div class="page-content-wrapper">
            <div class="page-content">
                <div class="row">
                    <div class="col-md-12">
                        <h3 class="page-title row-br-b-wp">District Monthly Stock Sufficiency Report</h3>
                                            ...
                                            if ($wh_name == '') {
                                                ...
                                                switch ($user_lvl) {
                                                    ...
                                                    case 4:
                                                        ...
                                                        include("allcombos_stock_sufficiency.php");
                ...
                $qry = "SELECT
            			...
            			FROM
                			...
                			RIGHT JOIN (
                				...
                				WHERE tbl_warehouse.stkid = $stakeholder
