                ...
                if (isset($_POST['submit'])) {
                    ...
                    $qry = "
                                SELECT
                                    ...
                                    INNER JOIN stakeholder as stkofc ON tbl_warehouse.stkofficeid = stkofc.stkid
...
//    echo $qry;exit;
        ...
        foreach ($disp_arr as $year => $m_data) {
            ...
            foreach ($m_data as $mon => $item_data) {
                ...
                $it_34 = (!empty($item_data['IT-034']) ? $item_data['IT-034'] : '0');
                ...
                echo ' <td  style="text-align:left">' . $month . '</td>
                                                                ...
                                                                <td  style="text-align:right">' . number_format($it_34) . '</td>
                                                                <td  style="text-align:right">' . number_format(($it_6 + $it_7 + $it_34)) . '</td>
        ...
        echo '  <td  style="text-align:center"  colspan="2">Total</td>
                                                ...
                                                <td  style="text-align:right">' . number_format($total_34) . '</td>
                                                <td  style="text-align:right">' . number_format(($total_6 + $total_7 + $total_34)) . '</td>
        ...
        echo '  <td  style="text-align:center"  colspan="2">CYP</td>
                                                ...
                                                <td  style="text-align:right">' . number_format(array_sum($prod_totals['IT-034']['CYP'])) . '</td>
                                                <td  style="text-align:right">' . number_format((array_sum($prod_totals['IT-006']['CYP']) + array_sum($prod_totals['IT-007']['CYP']) + array_sum($prod_totals['IT-034']['CYP']))) . '</td>
        ...
        echo '  <td style="text-align:center" colspan="2">USERS</td>
                                                ...
                                                <td  style="text-align:right">' . number_format(array_sum($prod_totals['IT-034']['USER'])) . '</td>
                                                <td  style="text-align:right">' . number_format((array_sum($prod_totals['IT-006']['USER']) + array_sum($prod_totals['IT-007']['USER']) + array_sum($prod_totals['IT-034']['USER']))) . '</td>
