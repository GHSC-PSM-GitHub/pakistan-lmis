...
$report_display_type=isset($report_display_type)?$report_display_type:'';
//Populate arrays
//hfPrograms
$hfPrograms = array(1, 2, 4, 11);
//monthArr
$monthArr = array('form14', 'clr11', 'dpw_punjab', 'spr1', 'spr2', 'pwd3', 'outletCYP', 'distCYP', 'satellite','src_d');
//yearArr
$yearArr = array('form14', 'clr11', 'dpw_punjab', 'spr1', 'spr2', 'pwd3', 'outletCYP', 'distCYP', 'satellite','src_d');
//dateRange
$dateRange = array('stkiss', 'form14y', 'clr11y', 'spr1y', 'spr2y', 'pwd3y', 'spr3', 'outletp', 'spr8', 'sdp_p', 'rcp1', 'rcp2', 'swp', 'dpr', 'spr9', 'spr10', 'spr11', 'clr13', 'clr15','sat2', 'dpw_f1', 'satellite', 'satellite_detail');
//stakeholderArr
$stakeholderArr = array('dpr', 'rcp2', 'clr11', 'dpw_punjab', 'clr13', 'clr15','sat2', 'outletCYP', 'distCYP', 'spr2y', 'clr11y', 'form14y','sdp_batches','src_d');
//provinceArr
$provinceArr = array('form14', 'clr11', 'dpw_punjab', 'spr1', 'spr2', 'pwd3', 'form14y', 'outletp', 'clr11y', 'spr1y', 'spr2y', 'pwd3y', 'spr3', 'outletCYP','sdp_batches', 'distCYP', 'spr8', 'sdp_p', 'rcp2', 'rcp1', 'swp', 'dpr', 'spr9', 'spr10', 'spr11', 'clr13', 'clr15','sat2', 'dpw_f1', 'satellite', 'satellite_detail','src_d');
//districtArr
$districtArr = array('spr8', 'sdp_p', 'rcp1', 'dpr', 'spr9', 'spr10', 'spr11', 'clr13', 'outletp', 'clr15','sat2', 'dpw_f1', 'satellite','sdp_batches', 'satellite_detail','src_d');
//hfTypeArr
$hfTypeArr = array('spr2', 'sdp_p', 'spr2y', 'pwd3', 'pwd3y', 'outletp', 'spr10');
//producteArr
$producteArr = array('clr11', 'dpw_punjab', 'clr11y');
//satelliteArr
...
$summary_or_detail=array('satellite_detail');
...
//    echo $queryprov;
            ...
            ?>
                <?php
            if (in_array($rptId, $summary_or_detail)) {
                ?>
                <div class="col-md-2">
                    <div class="form-group" id="checkboxDiv">
                        <label class="control-label">Report Type</label>
                        <div class="form-group">
                            <select name="summary_or_detail" id="summary_or_detail" class="form-control input-sm">
                                <option value="summary" <?=($report_display_type=='summary')?'selected':''?>>Summary</option>
                                <option value="detail"  <?=($report_display_type=='detail')?'selected':''?>>Detail</option>
                            </select>
                        </div>
                    </div>
                </div>
