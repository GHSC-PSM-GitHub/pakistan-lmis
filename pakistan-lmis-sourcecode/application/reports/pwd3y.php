...
//    $selYear = mysql_real_escape_string($_POST['year_sel']);
    ...
    $stk = mysql_real_escape_string($_SESSION['user_stakeholder']);
    //set and
    ...
    //file name
    $fileName = 'PWD3' . $provinceName . '_for_' . str_replace(" ","",str_replace("'","",str_replace("-","",$reportingDate))) . '_' . $hfTypeName;
}
?>
</head>
<!-- END HEAD -->
                ...
                if (isset($_POST['submit'])) {
                    ...
                    $qry = "SELECT 
							...
							FROM (
								...
								WHERE
									DATE_FORMAT(tbl_hf_type_mother_care.reporting_date,'%Y-%m') $reportingDate
                                ...
                                <tr>
                                    <td align="center">
                                        <h4 class="center">
                                            ...
                                            ?><br>
                                            <?php echo $reportingPeriod . ', Province ' . $provinceName; ?>
                                        </h4>
                                    </td>
                                </tr>
                                <tr>
