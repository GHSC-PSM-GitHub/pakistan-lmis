                    ...
                    if (mysql_num_rows(mysql_query($qry)) > 0) {
                        ...
                        <div class="col-md-12" style="overflow:auto;">
                            ...
                            while ($row = mysql_fetch_array($qryRes)) {
                                if($row['category'] == 2){ 
                                    $row['CYP'] = $cyp_array[$selProv][$stakeholder][$row['itm_id']] * $row['CS_Performed'];
                                }
                                else {
                                    $row['CYP'] = $cyp_array[$selProv][$stakeholder][$row['itm_id']]  * $row['performance'];
                                }
