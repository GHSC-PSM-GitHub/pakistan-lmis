...
<div class="col-md-2">
    <div class="form-group">
        ...
        <div class="form-group">
            <select name="report_by" id="report_by" required class="form-control input-sm">
...
<div class="col-md-2">
    <div class="col-md-12">
        <div class="form-group">
            ...
            <select name="district[]" id="district" size="8" class="multiselect-ui form-control input-sm" multiple>
