...
//apply check for jedelle in province kp only
if ($selPro != 'all' && !empty($selPro) && $selPro == 3 && $selItem == 'IT-013' && $selStk == 1) {
    $proFilter = " AND tbl_warehouse.prov_id = $selPro AND tbl_warehouse.hf_type_id = 4 ";
    $proFilter1 = " AND tbl_hf_type_rank.province_id = $selPro ";
}
else if ($selPro != 'all' && !empty($selPro)) {
    ...
    <div class="page-container">
        ...
        <div class="page-content-wrapper">
            <div class="page-content">
                <div class="row">
                    <div class="col-md-12">
                        <h3 class="page-title row-br-b-wp">MNCH Field Stock Availibility Report</h3>
                                    ...
                                    <table id="myTable">
                                        ...
                                        <tr>
                                            ...
                                            <td class="col-md-2"><label class="control-label">Product</label>
                                                <select name="item_id" id="item_id" required class="form-control input-sm select2me">
                                                    <option value="">Select</option>
                                                </select></td>
                                            <td class="col-md-2"><label class="control-label">Indicator</label>
                                                <select name="type" id="type" required class="form-control input-sm select2me">
                                                    <option value="">Select</option>
