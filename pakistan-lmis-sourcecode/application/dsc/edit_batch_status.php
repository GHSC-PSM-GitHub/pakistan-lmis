#####################
Batch Text Replacer Demo ID:543470
#####################
<?php
/**
 * stock_receive
...
<!--                                            <th>Unit</th>-->
                                            ...
                                            <th width="20%">Physical Inspection</th>
                                        </tr>
                                    </thead>
                                    <!-- // Table heading END --> 
...
<!--                                                         <select name="dtl" id="dtl" class="form-control" required >
                                                        ...
                                                        <a data-v="0" data-batch-id="<?=$row->BatchID?>"  class="dtl_<?=$row->BatchID?> dtl_action dtl_<?=$row->BatchID?>_0 btn btn-xs <?=($row->dtl=='0')?" green ":" default "?>">Inprocess</a>
                                                        <a data-v="1" data-batch-id="<?=$row->BatchID?>"  class="dtl_<?=$row->BatchID?> dtl_action dtl_<?=$row->BatchID?>_1 btn btn-xs <?=($row->dtl=='1')?" green ":" default "?>">Completed</a>
                                                        <a data-v="2" data-batch-id="<?=$row->BatchID?>"  class="dtl_<?=$row->BatchID?> dtl_action dtl_<?=$row->BatchID?>_2 btn btn-xs <?=($row->dtl=='2')?" green ":" default "?>">NA</a>
                                                        
                                                    </td>
                                                    <td class="text-center">
                                                        
                                                        <a data-v="0" data-batch-id="<?=$row->BatchID?>"  class="phy_<?=$row->BatchID?> phy_action phy_<?=$row->BatchID?>_0 btn btn-xs <?=($row->phy_inspection=='0')?" green ":" default "?>">Inprocess</a>
                                                        <a data-v="1" data-batch-id="<?=$row->BatchID?>"  class="phy_<?=$row->BatchID?> phy_action phy_<?=$row->BatchID?>_1 btn btn-xs <?=($row->phy_inspection=='1')?" green ":" default "?>">Completed</a>
                                                        <a data-v="2" data-batch-id="<?=$row->BatchID?>"  class="phy_<?=$row->BatchID?> phy_action phy_<?=$row->BatchID?>_2 btn btn-xs <?=($row->phy_inspection=='2')?" green ":" default "?>">NA</a>
...
#####################
Batch Text Replacer Demo ID:4778116
#####################
