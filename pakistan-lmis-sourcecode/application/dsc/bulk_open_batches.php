                                                        ...
                                                        <?php
                                                                    ...
                                                                    if (mysql_num_rows($warehouses) > 0) {
                                                                        while ($row = mysql_fetch_object($warehouses)) {
                                                                            ...
                                                                            $sel = "";
                                                                            if(!empty($funding_source) && $row->wh_id == $funding_source)$sel = " selected ";
                                                                            ?>
                                                        <?php //populate receive_from Combo?>
                                                        <option value="<?php echo $row->wh_id; ?>" <?=$sel?> <?php if (!isset($open_form)){ echo ' selected '; } ?>> <?php echo $row->wh_name; ?> </option>
                                                        <?php
        }
    }
    ?>
                                            ...
                                            <div class="col-md-3">
                                                ...
                                                <div class="controls">
                                                    <select name="product" id="product" required="true" class="input-medium select2me"  <?php if (!empty($open_form)){ echo 'readonly'; } ?>>
                                                        <option value=""> Select </option>
                                                        <?php
                                                        ...
                                                        if (mysql_num_rows($items) > 0) {
                                                            ...
                                                            while ($row = mysql_fetch_object($items)) {
                                                                ...
                                                                $sel = '';
                                                                if (!empty($productID) && $productID == $row->itm_id) {
                                                                    $sel = ' selected ';
                                                                }
                                            ...
                                            <div class="col-md-3">
                                                ...
                                                <div class="col-md-3"> <a class="btn btn-primary alignvmiddle" style="display:none;" id="add_m_p"  onclick="javascript:void(0);" data-toggle="modal"  href="#modal-manufacturer">Add</a> </div>
                                                ...
                                                <div class="col-md-2">
                                                    ...
                                                    {
                                                        ?>
                                                        <button style="margin-top: 20px;" type="submit" class="btn green btn-sm" id="open_form" name="open_form" value="open_form">Start Opening Balance</button>
                                                        <?php
                                                    }
                                                    ?>
                                                    </div>
        ...
        <script>
            ...
            $("#product").change(function() {
                ...
                $.ajax({
                    ...
                    cache: false,
                    data: {'pk_id': product}, // since, you need to delete post of particular id
                    dataType: 'json',
                    success: function(data) {
