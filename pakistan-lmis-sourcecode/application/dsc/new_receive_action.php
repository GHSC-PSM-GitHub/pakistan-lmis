#####################
Batch Text Replacer Demo ID:2064913672
#####################
<?php
...
//check price
$rprice = '';
if (isset($_REQUEST['rprice']) && !empty($_REQUEST['rprice'])) {
    //get batch
...
if ($strDo == "Add") {
    ...
    $objStockDetail->receiving_price = $rprice;
    $objStockDetail->save();
...
?>
#####################
Batch Text Replacer Demo ID:3181715
#####################
