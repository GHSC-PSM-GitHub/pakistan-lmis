#####################
Batch Text Replacer Demo ID:4506757708
#####################
<?php
/**
 * requisition
                            ...
                            <div class="widget-body">
								...
								if (!$is_provincial_user) {
                                                                    if ($row['approval_status'] == 'Prov_Approved') {
                                                                        ?>| <a href="<?php echo APP_URL ?>im/approve_clr6_national.php?id=<?php echo $row['pk_id']; ?>&wh_id=<?php echo $row['wh_id']; ?>&rq=<?php echo $row['requisition_num'] ?>">Approve</a>
                                                                        <?php 
                                                                        
                                                                    } else if ($row['approval_status'] == 'Approved') {
                                                                        ?>| <a href="<?php echo APP_URL ?>im/issue.php?id=<?php echo $row['pk_id']; ?>&wh_id=<?php echo $row['wh_id']; ?>&rq=<?php echo $row['requisition_num'] ?>">Issue</a>
                                                                            <?php 
                                                                            
                                                                    } else if ($row['approval_status'] == 'Issue in Process') {
                                                                        ?>| <a href="<?php echo APP_URL ?>im/issue.php?id=<?php echo $row['pk_id']; ?>&wh_id=<?php echo $row['wh_id']; ?>&rq=<?php echo $row['requisition_num'] ?>">Issue</a>
                                                                            <?php 
                                                                            
                                                                    } else if ($row['approval_status'] == 'Issued') {
        ...
        function showDistricts() {
            ...
            if (pid != '')
            {
                $.ajax({
                    ...
                    type: 'POST',
                    data: {pid: pid,user_level:<?php echo $_SESSION['user_level']?>, distId: '<?php echo $sel_dist; ?>'},
...
#####################
Batch Text Replacer Demo ID:48497872
#####################
