#####################
Batch Text Replacer Demo ID:6847295
#####################
<?php
/**
    ...
    switch ($office) {
        ...
        case 7: 
            ...
            if($_SESSION['user_stakeholder1']==145) {
                ...
                $result = $objwarehouse->GetHealthFacilityWarehousesofDistrictIRMNCH($combo2, $mainstk);
            }
            else{
                
                $result = $objwarehouse->GetHealthFacilityWarehousesofDistrict($combo2, $mainstk);
            }
            ?>
            <option value="">Select</option>
            <?php
...
#####################
Batch Text Replacer Demo ID:5556834322
#####################
