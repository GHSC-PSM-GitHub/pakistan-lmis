#####################
Batch Text Replacer Demo ID:0452167894
#####################
<?php
/**
 * approve_clr6_prov
                                            ...
                                            <form name="approve_clr6" id="approve_clr6" action="clr6_approve_prov_action.php" method="POST" onSubmit="return formValidation()">
                                                ...
                                                foreach ($product as $proId => $proName) {
                                                   ...
                                                   while ($row_2 = mysql_fetch_assoc($rsSql)) {
                                                       ...
                                                       $stock_row.= '<tr>
                                                               <td class="center">'.$c2++.','.$_SESSION['user_province1'].'</td>
                                                   ...
                                                   if(!empty($closing_bal[$proId]) && $closing_bal[$proId]>0 )
                                                   {
                                                       $stock_row.= '<tr>
                                                               <td class="center">'.$c2++.'</td>
                                                               <td class="center" colspan="2"><b>National Stock Quota</b></td>
                                                               <td class="right"><b>'.number_format($closing_bal[$proId]).'</b></td>
                                                               <td class="right"></td>
                                                           </tr>';
                                                       $prod_avail += $closing_bal[$proId];
                                                   }
                                                        ...
                                                        <td class="right">
                                                            <div class="row">
                                                                <div class="col-md-12">
                                                                    ...
                                                                    <a class="clickable <?=((isset($prod_avail)&&$prod_avail>0)?'':'hide')?>" data-toggle="collapse"   id="<?=$count?>" data-target=".<?=$count?>_collapsed"><i class="fa fa-info-circle" style="font-size:18px;color:blue !important;"></i></a>
                                                                </div>
                                                            </div>
                                                        </td>
                                                        <td class="right">
                                                            <?=number_format(!empty($reserved_arr[$proId])?$reserved_arr[$proId]:'0')?>
                                                        </td>
                                                        <td class="right">
                                                            <?php
                                                                $remaining=0;
                                                                $remaining = ($prod_avail - (!empty($reserved_arr[$proId])?$reserved_arr[$proId]:'0'))
                                                            ?>
                                                ...
                                                <tr>
                                                    <td colspan="10" style="text-align:right;" id="printButt">
                                                        ...
                                                        <div class="pull-right"> 
                                                            ...
                                                            <input type="submit" id="save_btn"    name="submit" value="Save" value="Save As Draft" class="btn btn-green">
            ...
            if (confirm('Are you sure you want to submit changes?'))
            {
                ...
                for (var i = 0; i < inp.length; i++) {
                    if (inp[i].value != '') {
                        ...
                        console.log ('ID:'+i+',prod:'+prod_name+', orig:'+orig_val+',remarks:'+remark);
...
#####################
Batch Text Replacer Demo ID:7427617076
#####################
