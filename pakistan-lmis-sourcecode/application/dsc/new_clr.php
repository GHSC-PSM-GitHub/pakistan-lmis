#####################
Batch Text Replacer Demo ID:5225868505
#####################
<?php
...
if (isset($_POST['submit'])) {
   ...
   //echo '<pre>';print_r($_REQUEST);exit;
   if(empty($_POST['chk'])){
        $url = 'new_clr.php?month='.$_REQUEST['month'].'&year='.$_REQUEST['year'].'&wh_to='.$_REQUEST['wh_id'];
    ...
    if ($qry['Num'] == 0) {
        ...
        $qry = "INSERT INTO clr_master
                SET
                        ...
                        requested_on = NOW() ";
        if($_POST['wh_id']==25057)
        {
            $qry .= " , approval_status = 'RS_Approved' ";
        }
        mysql_query($qry);
            ...
            if(in_array($_POST['itm_id'][$i], $_POST['chk']))
            {
                 ...
                 $qry = "INSERT INTO clr_details
                    SET
                            ...
                            remarks_dist_lvl1 = '" . mysql_real_escape_string($_POST['remarks'][$i]) . "' ";
                 if($_POST['wh_id']==25057)
                {
                    $qry .= " , qty_req_prov = '" . str_replace(',','',$_POST['quantity_requested'][$i]) . "'  ";
                }
                    //echo $qry;exit;
                 mysql_query($qry);
            }
        }
        $url = ($_SESSION['user_level'] == 2) ? 'requisitions.php' : 'clr6_list.php';
                                                ...
                                                <?php if ($_SESSION['user_level'] == 2) { ?>
                                                    <div class="col-md-3">
                                                        <div class="control-group">
                                                            <label>District Store / Warehouse</label>
                                                            <div class="controls">
                                                                <select name="district" id="district" required="required" class="form-control input-medium">
                                                                    <option value="">Select</option>
                                                                    <?php
                                                                    if($_SESSION['user_stakeholder1'] == 9 && $_SESSION['user_province1'] == 2)
                                                                    {
                                                                        if (!empty($wh_id) && $wh_id == $_SESSION['user_warehouse']) {
                                                                            $sel = "selected='selected'";
                                                                        } else {
                                                                            $sel = "";
                                                                        }
                                                                        echo '<option '.$sel.' value="'.$_SESSION['user_warehouse'].'">PPHI Sindh Provincial Stores</option>';
                                                                    }
                                                                    $qry = "SELECT DISTINCT
                                                                                    tbl_warehouse.wh_id,
                                                                                    tbl_locations.LocName
                                                                    ...
                                                                    while ($row = mysql_fetch_array($qryRes)) {
                                                                        if (!empty($wh_id) && $wh_id == $row['wh_id']) {
                                                                            $sel = "selected='selected'";
                                                                        } else {
                                                                            $sel = "";
                                                                        }
...
//fetch result
                            ...
                            if (isset($_REQUEST['year']) && isset($_REQUEST['month'])) {
                                ...
                                $cons_level = 4;
                                // removing the following condition as per CLMIS-1367
                                //if($_SESSION['user_stakeholder1'] == 156) $cons_level = 3; 
                                  ...
                                  $qry = "SELECT
                                                ...
                                                SUM(IF(stakeholder.lvl = $cons_level AND tbl_wh_data.RptDate = '$reportingDate',tbl_wh_data.wh_issue_up,0)) AS cons_last_mon,
                                                SUM(IF(stakeholder.lvl = $cons_level, tbl_wh_data.wh_issue_up, 0)) AS Consumption,
                                                SUM(IF(stakeholder.lvl = 3 AND tbl_wh_data.RptDate = '$reportingDate', tbl_wh_data.wh_cbl_a, 0)) AS SOHDistrict,
                                                SUM(IF(stakeholder.lvl = $cons_level AND tbl_wh_data.RptDate = '$reportingDate', tbl_wh_data.wh_cbl_a, 0)) AS SOHField
                                        FROM
                                                tbl_warehouse
                                  ...
                                  if($_SESSION['user_stakeholder1'] == 9 && $_SESSION['user_province1'] == 2 && $_REQUEST['district'] == 25057)
                                  {
                                        $qry .= " AND tbl_warehouse.prov_id = ".$_SESSION['user_province1']."  ";
                                  }
                                  else
                                  {
                                        $qry .= " AND tbl_warehouse.dist_id = $distId  ";
                                  }
                                        ...
                                        <div style="margin-left:0px !important; width:100% !important;">
                                            ...
                                            <form name="frm" id="frm" method="post" action="">
                                                <table width="100%" id="myTable" cellspacing="0" align="center">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        if ($show_part_a) {
                                                            ...
                                                            <tr height="30"  style="background-color:#eee">
                                                                <td colspan="<?php echo count($itemIds) + 2; ?>">Part - A (District Population Welfare Office - DPWO)</td>
                                                            </tr>
                                                            <tr>
                                                    ...
                                                    <tr style="background-color:#D1E4EB">
                                                    ...
                                                    <tr>
                                                        ...
                                                        foreach ($itemIds as $itemId) 
                                                        {
                                                            echo '<td class="TAR td_chk cls_print_input\" data-itm-id=\"$itm\"><textarea rows="2" cols="10"  maxlength="500" class="form-control  input-sm remarks_box" data-id="'.$itemId.'" name="remarks[]"></textarea><span id="msg_'.$itemId.'" class="red"></span></td>';    
                                                        }
                                                    ?>
...
#####################
Batch Text Replacer Demo ID:193238
#####################
