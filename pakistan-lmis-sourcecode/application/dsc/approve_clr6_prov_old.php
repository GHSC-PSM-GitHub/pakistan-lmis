#####################
Batch Text Replacer Demo ID:545219
#####################
<?php
/**
 * approve_clr6_prov
...
<body class="page-header-fixed page-quick-sidebar-over-content" >
                                            ...
                                            <form name="approve_clr6" id="approve_clr6" action="clr6_approve_prov_action.php" method="POST" onSubmit="return formValidation()">
                                                ...
                                                foreach ($product as $proId => $proName) {
                                                    ...
                                                    <tr>
                                                        ...
                                                        <?php
                                                            if($masterStatus == 'Prov_Saved' ||$masterStatus=='Prov_Approved')
    ...
    <?php /* ?><input type="checkbox" name="approve[<?php echo $proId?>]"  <?php if($status[$proId]=='Approved' || $status[$proId]=='Denied' || $status[$proId]=='Issued' ){echo "disabled=disabled";} else {echo "checked=checked";}?>/><?php */ ?>
                                                         ...
                                                         <td class="left"><input class="form-control input-small input-sm remarks_box" type="text" name="remarks_prov[<?php echo $proId ?>]" id="remarks_prov[<?php echo $proId ?>]" value="<?php echo $remarks_prov[$proId]; ?>" style="text-align:right;" /></td>
                                                ...
                                                <tr>
                                                    <td colspan="10" style="text-align:right;" id="printButt">
                                                        ...
                                                        if ($masterStatus != 'Issued') {
                                                            ?>
                                                        <a href="clr6_recalculate.php?referral=approve_clr6_prov&<?php echo $_SERVER['QUERY_STRING']; ?>" class="btn btn-success"><i class="fa fa-refresh" /></i> Refresh </a>
...
#####################
Batch Text Replacer Demo ID:3575930518
#####################
