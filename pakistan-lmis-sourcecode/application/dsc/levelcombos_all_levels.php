#####################
Batch Text Replacer Demo ID:7602213
#####################
<?php
/**
...
//print_r($user_lvl);exit;
$category = '1,4';
$stk_where = " ";


$category = '5';
$stk_where = " AND stakeholder.stkid in (7,376) ";
...
switch ($user_lvl) {
    ...
    case 2:
        ...
        break;
    case 3:
        if ($_SESSION['user_stakeholder1'] == 7 || $_SESSION['user_stakeholder1'] == 951) {
            $arrayProv = array(
                //'1' => 'Central',
                //  '3' => 'Division',
                '2' => 'Province',
...
while ($arryStk = mysql_fetch_assoc($resMainStk)) {
    ...
    <div class="col-md-2" style="display:none;" id="office-span">
        <label for="office" >Store Level <span class="red">*</span></label>
        <div class="controls">
...
while ($row = mysql_fetch_object($arrayDistricts)) {
    ...
    <div class="col-md-4" id="wh_combo" <?php if (empty($warehouse)) { ?> style="display:none;" <?php } ?>>
...
#####################
Batch Text Replacer Demo ID:955111394
#####################
