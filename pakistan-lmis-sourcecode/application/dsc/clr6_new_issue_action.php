#####################
Batch Text Replacer Demo ID:652277
#####################
<?php
...
WHERE
	tbl_stock_master.PkStockID = $fkStockID";
...
//   echo '<pre>To list:';print_r($to_list);print_r($cc_list);
//  
//   echo '<pre>proc by arr :';print_r($proc_by_arr); 
//   echo '<pre>shipment:';print_r($shipment_stk_arr); 
//   echo '<pre>shipment detail:';print_r($shipment_detail);exit;
...
?>
#####################
Batch Text Replacer Demo ID:528311025
#####################
