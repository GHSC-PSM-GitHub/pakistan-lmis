#####################
Batch Text Replacer Demo ID:1024758
#####################
<?php
/**
 * new_issue
...
//}
    ...
    $_SESSION['lastTransStk'] = 7;
    $_SESSION['lastTransWH'] = '';
    if($_SESSION['user_level'] == '7')    $_SESSION['lastTransOffice'] = 9;
    else  $_SESSION['lastTransOffice'] = 7;
    $_SESSION['lastTransProv'] = 3;
    $_SESSION['lastTransDist'] = $_SESSION['user_district'];
?>
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <div class="col-md-3">
                                                <div class="control-group">
                                                    ...
                                                    <div class="controls">
                                                        <input class="form-control input-medium" id="issue_date" readonly name="issue_date" required type="text" value="<?php echo $TranDate; ?>"/>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-3">
                                            ...
                                            <div class="col-md-3">
                                                <div class="control-group">
                                                    <label class="control-label" for="firstname"> Delivery Mode /  Issued By </label>
                                                    <div class="controls">
...
<?php if ( true) { ?>
                                                <div class="col-md-3">
                                                    <div class="control-group">
                                                        <label class="control-label" for="firstname"> Funding Source </label>
                                                        <div class="controls">
                                                            <select name="funding_source" id="funding_source" class="form-control input-medium" >
...
<?php } ?>
                                            <div class="col-md-3">
                                                <div class="control-group">
                                                    ...
                                                    <div class="controls">
                                                        <select name="product" id="product" class="input-medium select2me" required="true">
                                            ...
                                            <?php if(($_SESSION['user_role'] == '65') && ($_SESSION['user_province'] == '3')) { ?>
                                            <div class="col-md-3" id="mcc_generic_name_div" style="display:none;">
                                                <label class="control-label" for="mcc_generic_name"> Generic Name </label>
                                                <div class="controls">
                                                    <input type="text" class="form-control input-medium" name="mcc_generic_name" id="mcc_generic_name" readonly />
                                                </div>
                                            </div>
                                            
                                            <div class="col-md-3" id="mcc_category_div" style="display:none;">
                                                <label class="control-label" for="mcc_category"> MCC Category </label>
                                                <div class="controls">
                                                    <input type="text" class="form-control input-medium" name="mcc_category" id="mcc_category" readonly />
                                                </div>
                                            </div>
                                            <?php } ?>
...
<?php if ($tempstocks != FALSE) { ?>
    ...
    <?php
    if (!empty($_SESSION['user_level']) && $_SESSION['user_level'] < 2 && $_SERVER['SERVER_ADDR'] != '::1') {
        ?>
        <div id="wms_alert" class="modal fade col-md-6 center-block" style="margin-top: 20px;" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
            <div class="modal-header">
                <h3 id="myModalLabel"><b class="red">WMS Alert !</b></h3>
            </div>
            <div class="modal-body" style="background-color:white;">
                <pre>Dear WM User, 

                     <b class="red">Very Soon </b> “Central Warehouse Direct  Stock Issuance Form” 
                    shall be blocked. 

                    Central Warehouse shall be able to issue stock against CLR-6 in requisitions section.

                    We are encouraging all users to <b>start following the requisition cycle.</b>

                    For any queries , feel free to contact our support.
                </pre>
            </div>
...
#####################
Batch Text Replacer Demo ID:719652
#####################
