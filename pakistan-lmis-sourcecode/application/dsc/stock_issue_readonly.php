#####################
Batch Text Replacer Demo ID:07352391
#####################
<?php
/**
 * stock_issue
...
$result                 = $objStockMaster->StockIssueSearch_multi_wh(2, $warehouses_assigned);
                                        ...
                                        if ($result != FALSE) {
                                            ...
                                            while ($row = mysql_fetch_object($result)) {
                                                ...
                                                <tr class="gradeX" style="background-color:<?php echo $row->field_color; ?> !important" id="<?php echo $row->PkDetailID; ?>">
                                                    ...
                                                    <td><?php echo $row->issued_by_wh; ?>&nbsp;</td>
...
#####################
Batch Text Replacer Demo ID:451477
#####################
