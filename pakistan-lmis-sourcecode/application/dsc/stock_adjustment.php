#####################
Batch Text Replacer Demo ID:723225020
#####################
<?php
/**
 * stock_adjustment
...
if($_SESSION['user_role']==69){
    redirect('stock_adjustment_readonly.php');
    exit;
}
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="widget" data-toggle="collapse-widget">
                            ...
                            <div class="widget-body"> 
                                ...
                                <!-- Table --> 
                                <!-- Table -->
                                <table class="adjustment table table-striped table-bordered table-condensed" id="example">
                                    ...
                                    <tbody>
                                        ...
                                        if ($adjustment_list != FALSE) :
                                            while ($row = mysql_fetch_object($adjustment_list)) :
                                                ?>
                                                <tr class="gradeX" id="<?=$row->PkDetailID?>">
                                                    ...
                                                    <td><?php echo "<a href=\"javascript: void(0)\" onClick=\"delete_adjustment(" . $row->PkDetailID . ")\"><img src=\"" . PUBLIC_URL . "images/cross.gif\" class=\"cursor\"></a>"; ?></td>
                                               </tr>
                                                <?php
                                                $i++;
                                            endwhile;
...
#####################
Batch Text Replacer Demo ID:7291261
#####################
