#####################
Batch Text Replacer Demo ID:0395947
#####################
<?php
/**
 * batch_management
...
//    $items = $objManageItem->GetAllManageItem(5);
//else
...
<body class="page-header-fixed page-quick-sidebar-over-content" >
 ...
 <div class="widget-body"><img src="../../public/images/excel-16.png" <i id="btnExport" onclick="fnExcelReport();" class="fa fa-file-excel-o" style="font-size:32px;color:#FF0000;float: right;"></i>
                            ...
                            <div class="widget-body"> 
                                ...
                                <!-- Table --> 
                                <!-- Table -->
                                <table class="batchmanagement table table-striped table-bordered table-condensed" id="example">
                                        ...
                                        if (!empty($data) && mysql_num_rows($data) > 0) {
                                            ...
                                            while ($row = mysql_fetch_object($data)) {
                                                ...
                                                <tr class="gradeX">
                                                    ...
                                                    <td><?php echo $row->itm_name.(!empty($row->generic_updated)?' ['.$row->dosage_form.' '.$row->generic_updated.' '.$row->strength.']':''); ?></td>
...
#####################
Batch Text Replacer Demo ID:88356587
#####################
