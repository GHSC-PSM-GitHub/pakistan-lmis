#####################
Batch Text Replacer Demo ID:661335115
#####################
<?php
/**
 * ajax_stock_pick
            ...
            <div class="span8">
                ...
                //
                  $getLocsSql = "SELECT
									...
									SUM(placements.quantity / stakeholder_item.quantity_per_pack) AS quantityCarton,
                ...
                if (mysql_num_rows($resLocs) > 0) {
                    ?>
                    Product:<?php echo $item ?>, Batch No: <?php echo $batch_no['batch_no'] ?>, Expiry:<?php echo date('m/Y', strtotime($batch_expiry)); ?> . Can Pick : <?=number_format($maxValue)?>
                    <?php }
                    ?>
...
#####################
Batch Text Replacer Demo ID:612943
#####################
