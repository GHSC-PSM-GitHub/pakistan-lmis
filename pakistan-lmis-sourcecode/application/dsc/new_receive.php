#####################
Batch Text Replacer Demo ID:191627
#####################
<?php
/**
 * new_receive
...
$items = $objManageItem->GetAllProductsOfMCC($stk);
//Get All Item Units
...
<body class="page-header-fixed page-quick-sidebar-over-content">
                                ...
                                <form method="POST" name="new_receive" id="new_receive" action="new_receive_action.php" >
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            ...
                                            <div class="col-md-5">
                                                ...
                                                <div class="col-md-3" style="margin-top: 30px; "> <a class="btn btn-primary alignvmiddle" style="display:none;" id="add_m_p"  onclick="javascript:void(0);" data-toggle="modal"  href="#modal-manufacturer">Add</a> </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            ...
                                            <div class="col-md-3" id="uprice_div" style="display:none;">
                                                <label class="control-label" for="uprice"> Price </label>
                                                <div class="controls">
                                                    <input type="text" class="form-control input-medium" name="uprice" id="uprice" readonly />
                                                </div>
                                            </div>
                                            <div class="col-md-3" id="rprice_div" style="display:none;">
                                                <label class="control-label" for="rprice"> Receiving Price <span class="red">*</span> </label>
                                                <div class="controls">
                                                    <input type="text" class="form-control input-medium" name="rprice" id="uprice"  />
                                                </div>
                                            </div>
                                            <?php } ?>
                                        </div>
    ...
    <script type="text/javascript">
        $('#product').change(function(){
            $('.alignvmiddle').css('display', 'block');
        });
    </script>
    <?php
...
#####################
Batch Text Replacer Demo ID:170209
#####################
