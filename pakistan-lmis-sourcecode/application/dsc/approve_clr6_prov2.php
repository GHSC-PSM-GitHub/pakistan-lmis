#####################
Batch Text Replacer Demo ID:358884
#####################
<?php
/**
 * approve_clr6_prov
...
$date_1 = date('Y-m-d');
$closing_bal_named_array = calculate_usaid_stock($date_1,$_SESSION['user_province1']);
//tytle
$title = "New Issue";
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="widget" id="printing">
                            ...
                            <div class="">
                                <h3 class="heading center">Province Level Requisition Approval</h3>
                            </div>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <table class="table table-striped table-bordered table-condensed">
                                            ...
                                            <tbody>
                                                <!-- Table row -->
                                            <form name="approve_clr6" id="approve_clr6" action="clr6_approve_prov_action.php" method="POST" onSubmit="return formValidation()">
                                                <?php
                                                $disabled = '';
                                                $readonly = '';
                                                $deniedSel = '';
...
//                                                                        AND national_stock.tr_date <= '".date('Y-m-d')."' 
//                                                                        AND itminfo_tab.itm_id = $proId
//                                                                    GROUP BY
//                                                                        tbl_locations.LocName,
//
//                                                                        itminfo_tab.itm_name
...
//                                                                    <td class="center grey" colspan="2"><b>National Quota </b></td>
//                                                                    <td class="right"><b>'.number_format($closing_bal[$row['itm_id']]).'</b></td>
//                                                                    <td class="right">-</td>
//                                                                </tr>';
//                                                            $prod_avail += $closing_bal[$row['itm_id']];
//                                                        }
                                                        ...
                                                        foreach($closing_bal_named_array as $p_name=>$p_arr){
                                                            foreach($p_arr as $itm_name=>$val){
                                                                $itm_id = $itm_name_id[$itm_name];
                                                                @$closing_bal[$itm_name_id[$itm_name]] = (($val>0)?$val:0);
                                                                
                                                                if($val>0 && $itm_id == $proId){
                                                                    $stock_row.= '<tr>
                                                                        <td class="center">'.$c2++.'</td>
                                                                        <td class="center bg-grey-cascade" colspan="2"><b>National Quota </b></td>
                                                                        <td class="right"><b>'.number_format($closing_bal[$itm_id]).'</b></td>
                                                                        <td class="right">-</td>
                                                                    </tr>';
                                                                    $prod_avail += $val;
                                                                }
                                                   ...
                                                   while ($row_2 = mysql_fetch_assoc($rsSql)) {
                                                       ...
                                                       //if(!empty($closing_bal[$proId]))
                                                       //     $qty+=$closing_bal[$proId];
                                                       
                                                       if( !empty($row_2['qty_carton']) && $row_2['qty_carton']>0)
                                                           $carton_available=$qty/$row_2['qty_carton'];
                                                       else
                                                           $carton_available=0;
                                                ...
                                                ?>
                                                    <tr >
                                                        ...
                                                        <td class="right">
                                                            <div class="row">
                                                                <div class="col-md-12">
                                                                    <input class="form-control input-small input-sm" type="text" name="qty_available[<?php echo $proId ?>]" id="qty_available[<?php echo $proId ?>]" value="<?php echo number_format($prod_avail); ?>" style="text-align:right;" readonly/>
                                                                    <a class="clickable" data-toggle="collapse" id="<?=$count?>" data-target=".<?=$count?>_collapsed"><i class="fa fa-info-circle" style="font-size:18px;color:blue !important;"></i></a>
                                                                </div>
                                                            </div>
                                                        </td>
                                                        <td class="right">
                                                        ...
                                                        //$approve_dist_reqs_is_active
                                                            ...
                                                            else if($masterStatus == 'Prov_Saved' ||$masterStatus=='Prov_Approved'||$masterStatus=='RS_Approved'||$masterStatus=='RS_Saved')
    ...
    <?php /* ?><input type="checkbox" name="approve[<?php echo $proId?>]"  <?php if($status[$proId]=='Approved' || $status[$proId]=='Denied' || $status[$proId]=='Issued' ){echo "disabled=disabled";} else {echo "checked=checked";}?>/><?php */ ?>
                                                    ...
                                                    <tr  class="collapse out budgets <?=$count?>_collapsed">
                                                        <td colspan="10">
                                                             <div class="row">
                                                                <div class="col-md-8">
                                                                    <table class="table table-striped table-bordered table-condensed">
                                                                        <tr  class="">
                                                                            <td class="center bg-blue-hoki">#</td>
                                                                            <td class="center bg-blue-hoki">Expiry Date</td>
                                                                            <td class="center bg-blue-hoki">Qty / Carton</td>
                                                                            <td class="center bg-blue-hoki">Qty Available</td>
                                                                            <td class="center bg-blue-hoki">Cartons Available</td>
                                                                        </tr>
                                                ...
                                                <tr>
                                                    <td colspan="10" style="text-align:right;" id="printButt">
                                                        ...
                                                        <a href="clr6_recalculate.php?referral=approve_clr6_prov&<?php echo $_SERVER['QUERY_STRING']; ?>" class="btn btn-success hide"><i class="fa fa-refresh" /></i> Refresh </a>
                                                            <input type="submit" id="save_btn"    name="submit" value="Save As Draft" class="btn btn-primary">
...
#####################
Batch Text Replacer Demo ID:2121503518
#####################
