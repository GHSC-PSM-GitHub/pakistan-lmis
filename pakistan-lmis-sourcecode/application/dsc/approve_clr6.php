#####################
Batch Text Replacer Demo ID:7308224718
#####################
<?php
/**
 * approve_clr6
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="widget" id="printing">
                            ...
                            <div class="">
                                <h3 class="heading center">District Level Requisition Approval</h3>
                            </div>
                                        ...
                                        <table class="table table-striped table-bordered table-condensed">
                                            ...
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th>Product</th>
                                                    <th>Replenishment *</th>
                                                    <th>Requested Qty (Manual)</th>
                                                    <th>Remarks for Qty</th>
                                                    <th class="hide">Available Qty</th>
                                                    <th>Approved Qty</th>
                                            ...
                                            <form name="approve_clr6" id="approve_clr6" action="clr6_approve_action.php" method="POST" onSubmit="return formValidation()">
                                                ...
                                                foreach ($product as $proId => $proName) {
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="left"><?php echo $remarks_dist_lvl1[$proId]; ?></td>
                                                        
                                                        <td class="right hide"><input class="form-control input-small input-sm" type="text" name="qty_available[<?php echo $proId ?>]" id="qty_available[<?php echo $proId ?>]" value="<?php echo number_format($availableQty[$proId]); ?>" style="text-align:right;" readonly/></td>
                                                        <td><input autocomplete="off" data-prod-name="<?php echo $proName;?>" <?php echo $readonly; ?> data-id="<?php echo $proId ?>" max="<?php echo $availableQty[$proId]; ?>" class="qty form-control input-small input-sm" type="text" name="qty_approved[<?php echo $proId ?>]" style="text-align:right;" id="qty_approved-<?php echo $proId ?>" value="<?php echo ((!empty($qty_req_dist_lvl1[$proId]))?$qty_req_dist_lvl1[$proId]:'')?>" data-orig-val="<?php echo ((!empty($qty_req_dist_lvl1[$proId]))?$qty_req_dist_lvl1[$proId]:'')?>" <?php echo $disabled; ?> />
                                                        </td>
                                                       
                                                        
                                                         <td class="left"><input class="form-control input-small input-sm remarks_box" data-id="<?php echo $proId ?>" type="text" name="remarks_dist_lvl2[<?php echo $proId ?>]" id="remarks_dist_lvl2[<?php echo $proId ?>]" value="<?php echo $remarks_dist_lvl2[$proId]; ?>" style="text-align:right;" /></td>
                                                ...
                                                <tr>
                                                    <td colspan="6" style="text-align:right;" id="printButt">
                                                        ...
                                                        if ($masterStatus != 'Issued') {
                                                            ...
                                                            ?>
                                                            <a href="clr6_recalculate.php?referral=approve_clr6&<?php echo $_SERVER['QUERY_STRING']; ?>" class="btn btn-success hide"><i class="fa fa-refresh" /> Refresh </a>
                                                    </td>
...
#####################
Batch Text Replacer Demo ID:1669992
#####################
