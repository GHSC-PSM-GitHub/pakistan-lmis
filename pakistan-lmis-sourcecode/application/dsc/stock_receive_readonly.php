#####################
Batch Text Replacer Demo ID:96973372
#####################
<?php
/**
 * stock_receive
...
//assign the warehouses list to this arr : $wh_arr
$warehouses_assigned    = $objwarehouse->get_assigned_warehouses($_SESSION['user_id']);
$result                 = $objStockMaster->StockSearch_multi_wh(1, $warehouses_assigned);
//title
$title = "Stock Receive";
...
#####################
Batch Text Replacer Demo ID:958200
#####################
