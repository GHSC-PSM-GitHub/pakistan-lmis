#####################
Batch Text Replacer Demo ID:7579251
#####################
<?php
...
if (isset($_REQUEST['tran_no'])) {
    ...
    if (!empty($tran_no)) {
        ...
        $strSql = "SELECT
						...
						(tbl_stock_detail.Qty / stakeholder_item.quantity_per_pack) AS cartonQty,
...
<body class="page-header-fixed page-quick-sidebar-over-content" onload="showVoucherList()">
    <!-- BEGIN HEADER -->
...
#####################
Batch Text Replacer Demo ID:634815
#####################
