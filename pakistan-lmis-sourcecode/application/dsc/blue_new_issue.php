#####################
Batch Text Replacer Demo ID:14371449
#####################
<?php
/**
 * new_issue
...
if ($_SESSION['user_level'] == '7')
    $_SESSION['lastTransOffice'] = 9;
else
    $_SESSION['lastTransOffice'] = 7;
                                                    ...
                                                    <div class="controls">
                                                        <select name="product" id="product" class="input-medium select2me" required="true">
                                                            ...
                                                            foreach ($items as $item) {
                                                                echo "<option value=" . $item['id'] . ">" . $item['name'] . ' ' . ((!empty($item['generic_name']) && $item['generic_name'] != 'NULL') ? '[' . $item['generic_name'] . ']' : '') . "</option>";
                                                            }
                                                            ?>
                                                        </select>
                                                    </div>
...
#####################
Batch Text Replacer Demo ID:94795198
#####################
