#####################
Batch Text Replacer Demo ID:8908695390
#####################
<?php
/**
     ...
     <b>Products Summary</b>
            ...
            foreach ($productArr as $key => $data) {
                    ...
                    foreach ($data as $val) {
                        ...
                        $total_price += number_format($val->unit_price,2) * $val->Qty;
                    ...
                    <tr>
                        ...
                        <td align="right"><?php echo number_format($totalCartons); ?></td>
                    </tr>
...
#####################
Batch Text Replacer Demo ID:881683
#####################
