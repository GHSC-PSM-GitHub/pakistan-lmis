#####################
Batch Text Replacer Demo ID:93894707
#####################
<?php
/**
 * placement_locations
...
$qry = "SELECT DISTINCT
                        ...
                        a.list_value AS area,
                        r.list_value AS `row`,
                        ra.list_value AS rack,
                        p.list_value AS pallet,
                        l.list_value AS `level`
                FROM
                placement_config
                LEFT JOIN placements ON placement_config.pk_id = placements.placement_location_id
                INNER JOIN list_detail AS a ON placement_config.area = a.pk_id
                INNER JOIN list_detail AS r ON placement_config.`row` = r.pk_id
                INNER JOIN list_detail AS ra ON placement_config.rack = ra.pk_id
                INNER JOIN list_detail AS p ON placement_config.pallet = p.pk_id
                INNER JOIN list_detail AS l ON placement_config.`level` = l.pk_id
                WHERE
...
<?php } ?>
                        ...
                        <div class="widget" data-toggle="collapse-widget">
                            ...
                            <div class="widget-body"> 
                                ...
                                <!-- Table --> 
                                <!-- Table -->
                                <table class="dynamicTable2 table table-striped table-bordered table-condensed" id="example">
                                        ...
                                        <!-- Table row -->
                                            ...
                                            <tr class="gradeX">
                                                ...
                                                <td><?php echo $row['level'] ?></td>
                                                    ...
                                                    <?php if ($_SESSION['user_role'] == 4 || $_SESSION['user_role'] == 38 || $_SESSION['user_role'] == 54) { ?>
                                                    <td class="center">
                                                        <?php
                                                        if (is_null($row['qty'])) {
                                                            ?>
...
#####################
Batch Text Replacer Demo ID:851648159
#####################
