    ...
    $("#issued_by").change(function() {
        ...
        if (issued_by == 122) {
            ...
            $('#nog_div').fadeOut();
             ...
             $('#idc_div').fadeOut();
             $('#dcn_div').fadeOut();
//            $('#rprice').attr('required',true);
        }
        else if (issued_by == 121)
        {
             $('#nog_div').fadeIn();
             $('#bn_div').fadeIn();
            $('#dn_div').fadeOut();
        ...
        else if (issued_by == 850)
        {
            ...
            $('#nog_div').fadeOut();
             ...
             $('#idc_div').fadeOut();
             $('#dcn_div').fadeOut();
//            $('#rprice').attr('required',false);
        }
        
//        $.ajax({
//            type: "POST",
//            url: "get_mcc_info1.php",
//            cache: false,
//            data: {'pk_id': issued_by}, // since, you need to delete post of particular id
//            dataType: 'json',
