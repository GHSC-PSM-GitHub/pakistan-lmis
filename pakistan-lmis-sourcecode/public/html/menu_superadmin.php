    ...
    <div class="page-sidebar-wrapper"> 
        ...
        <div class="page-sidebar navbar-collapse collapse"> 
            ...
            <ul class="page-sidebar-menu accordion" id="accordion">
                ...
                <li> <a href="<?php echo APP_URL; ?>admin/ManageHealthFacilityType.php"> <i class="fa fa-home"></i> <span class="title">HF Types</span> </a> </li>
                ...
                <li> <a href="javascript:;"> <i class="fa fa-users"></i> <span class="title"> Stakeholders</span> </a>
                    <ul class="sub-menu">
                        ...
                        <li><a href="<?php echo APP_URL; ?>admin/Assign_reporting_stakeholders.php">Manage Requisitions Flow of Stakeholders</a> </li>
                    </ul>
                </li>
