...
if (!isset($_SESSION['alert_counts'])) {
    ...
    $_SESSION['alert_counts']['po_alert_count'] = $objAlerts->count_po_alerts();
}
...
$proc_alert_count = $_SESSION['alert_counts']['po_alert_count'];
    ...
    <div class="header navbar"> 
        ...
        <div class="header-inner"> 
            ...
            if(!empty($_SESSION['user_role']) && $_SESSION['user_role']==38)
            {
             ...
             elseif(!empty($_SESSION['user_role']) && $_SESSION['user_role']==123)
            {
                ?>
                    <a class="navbar-brand" href="<?php echo SITE_URL; ?>" style="margin-top: -10px;"> <img src="<?php echo PUBLIC_URL; ?>assets/admin/layout/img/landing-images/kptb-logo.png" alt="LMIS - TB" /> </a> 
                <?php 
            }
             elseif(!empty($_SESSION['user_stakeholder']) && $_SESSION['user_stakeholder']==2680)
            {
                ?>
                    <a class="navbar-brand" href="<?php echo SITE_URL; ?>" style="margin-top: -10px;"> <img src="<?php echo PUBLIC_URL; ?>assets/admin/layout/img/landing-images/omis.png" alt="LMIS - OMIS" /> </a> 
                <?php 
            }
            elseif(!empty($_SESSION['user_role']) && $_SESSION['user_role']==125)
            {
                ?>
                    <a class="navbar-brand" href="<?php echo SITE_URL; ?>" style="margin-top: -10px;"> <img src="<?php echo PUBLIC_URL; ?>assets/admin/layout/img/landing-images/kptb-logo.png" alt="LMIS - TB" /> </a> 
                <?php 
            }
            elseif(!empty($_SESSION['user_role']) && $_SESSION['user_role']==90)
            {
                ?>
                    <a class="navbar-brand" href="<?php echo SITE_URL; ?>" style="margin-top: -10px;"> <img src="<?php echo PUBLIC_URL; ?>assets/admin/layout/img/landing-images/msd_balochistan.png" alt="LMIS - MSD" /> </a> 
                <?php 
            }
            elseif(!empty($_SESSION['user_role']) && $_SESSION['user_role']==96)
            {
                ?>
                    <a class="navbar-brand" href="<?php echo SITE_URL; ?>" style="margin-top: -10px;"> <img src="<?php echo PUBLIC_URL; ?>assets/admin/layout/img/landing-images/kp.png" alt="LMIS - MSD" /> </a> 
                <?php 
            }
			...
			elseif(!empty($_SESSION['user_role']) && ($_SESSION['user_role']==70 || $_SESSION['user_role']==73))
            {
                ?>
                    <a class="navbar-brand" href="<?php echo SITE_URL; ?>" style="margin-top: -10px;"> <img src="<?php echo PUBLIC_URL; ?>assets/admin/layout/img/landing-images/mnch_main_logo.png" height="55" width="323" alt="MNCH" /> </a> 
                <?php 
            } elseif(!empty($_SESSION['user_role']) && ($_SESSION['user_warehouse']==95502 || $_SESSION['user_role']==77 || $_SESSION['user_warehouse']==96596))
            {
                ?>
                    <a class="navbar-brand" href="<?php echo SITE_URL; ?>" style="margin-top: -10px;"> <img src="<?php echo PUBLIC_URL; ?>../application/ncov/MONHSnRCandNIHLogo.png" height="70" alt="nCOv" /> </a> 
                <?php 
            } 
            elseif($_SESSION['user_warehouse']==105554)
            {
                ?>
                    <a class="navbar-brand" href="<?php echo SITE_URL; ?>" style="margin-top: -10px;"> <img src="<?php echo PUBLIC_URL; ?>assets/img/landing-images/limsMain_logo.gif" height="70" alt="nCOv" /> </a> 
                <?php 
            } 
            elseif(!empty($_SESSION['user_role']) && ($_SESSION['user_warehouse']==96584))
            {
                ?>
                    <a class="navbar-brand" href="<?php echo SITE_URL; ?>" style="margin-top: -10px;"> <img src="<?php echo PUBLIC_URL; ?>../application/ndma/NDMALogo.png" height="70" alt="nCOv" /> </a> 
                <?php 
            }
            elseif(!empty($_SESSION['user_role']) && ($_SESSION['user_stakeholder']==1222))
            {
                ?>
                    <a class="navbar-brand" href="<?php echo SITE_URL; ?>" style="margin-top: -10px;"> <img src="<?php echo PUBLIC_URL; ?>../application/nhsrc/logo.png" height="70" alt="nhsrc" /> </a> 
                <?php 
            }
            elseif(!empty($_SESSION['user_role']) && ($_SESSION['user_stakeholder']==2697))
            {
                ?>
                    <a class="navbar-brand" href="<?php echo SITE_URL; ?>" style="margin-top: -10px;"> <img src="<?php echo PUBLIC_URL; ?>../application/undp/undp_logo.png" height="70" alt="undp" /> </a> 
                <?php 
            }
            elseif(!empty($_SESSION['user_role']) && ($_SESSION['user_role']==131 || $_SESSION['user_role'] == 132))
            {
                ?>
                    <a class="navbar-brand" href="<?php echo SITE_URL; ?>" style="margin-top: -10px;"> <img src="<?php echo PUBLIC_URL; ?>../application/kpivmp/kpivmp.png" height="70" alt="kpivmp" /> <span class="green" STYLE="font-size:24.0pt">KPIVMP</span> </a> 
                <?php 
            }
            elseif(!empty($_SESSION['user_role']) && ($_SESSION['user_role']==134 || $_SESSION['user_role'] == 135 || $_SESSION['user_role'] == 136))
            {
                ?>
                    <a class="navbar-brand"  href="<?php echo SITE_URL; ?>" style="margin-top: -10px; width:500px!important;"> <img src="<?php echo PUBLIC_URL; ?>../application/dcps/dcps_logo_transparent.png" height="70" alt="kpivmp" /> <span class="green" STYLE="font-size:14.0pt">Drug Control & Pharmacy Services</span> </a> 
                <?php 
            }
            else{
                ?>
            ...
            <ul class="nav navbar-nav pull-right">
                <?php
                if(isset($_SESSION['user_warehouse']) && $_SESSION['user_stakeholder']!=1222 && !is_request_from_mobile()) {
            ?>
                <li>
                        <a href="http://lmis.gov.pk/lmis_videos.php" target="_blank" class="ul-header">
                            <img src="http://v.lmis.gov.pk/common/assets/img/header-icon/training_videos.png" alt=""/>
                        </a>

                    </li>
            
            <?php }
            if ($_SESSION['user_warehouse'] != 95502 && $_SESSION['user_role']!=77 && $_SESSION['user_warehouse'] != 96584 && $_SESSION['user_warehouse'] != 96596 && $_SESSION['user_stakeholder']!=1222 && !is_request_from_mobile()) {
            ?>
                ...
                <li> <a href="https://v.lmis.gov.pk/docs/pakistan-supplychain-sops" target="_blank" class="ul-header"> <img src="<?php echo PUBLIC_URL; ?>assets/img/header-icon/publications.png" alt=""/> </a> </li>
                ...
                <ul class="page-breadcrumb breadcrumb">
                    <li class="btn-group-vertical pull-right">
                        ...
                        <ul class="dropdown-menu pull-right" role="menu">
                            <?php
                            if (isset($_SESSION['user_id']) && (!in_array($_SESSION['user_role'], array(16, 17, 77,78)))) {
                                ?>
...
ORDER BY
	tbl_user_login_log.pk_id DESC";
                     ...
                     <?php if ($_SESSION['user_role'] != 65  && $_SESSION['user_role'] != 67 && $_SESSION['user_warehouse'] != 95502 && $_SESSION['user_warehouse'] != 96584 && $_SESSION['user_warehouse'] != 96596 && $_SESSION['user_stakeholder']!=1222 && $_SESSION['user_role']!=77 && $_SESSION['user_role']!=78) { ?> 
                    <li class="btn-group-vertical pull-right">
                    ...
                    <?php if ($_SESSION['user_warehouse'] != 95502 && $_SESSION['user_warehouse'] != 96584 && $_SESSION['user_warehouse'] != 96596 && $_SESSION['user_stakeholder']!=1222 && $_SESSION['user_role']!=77 && $_SESSION['user_role']!=78) { ?> 
                    ...
                    <?php if ($_SESSION['user_stakeholder1'] == 1192) { ?> 
                        <li class=""  style="float:right; padding-right:10px">
                            <i class="fa fa-bell-o" style="color:black !important"></i>
                            <a style="cursor: pointer" onclick="window.open('../popups/procurement_alerts.php', '_blank', 'scrollbars=1,width=600,height=500');"> POs Delivering Soon</a>
                            <span class="badge  badge-info"><?= (isset($proc_alert_count) ? $proc_alert_count : '0') ?></span>
                        </li>
                        <li class=""  style="float:right; padding-right:10px"> 
                             <i class="fa fa-map-marker" style="color:black !important"></i>
                            <a style="cursor: pointer" onclick="window.open('http://lmis.gov.pk/ventilatormap/index.php');"> GIS Ventilator Map</a>
                         </li>
                        <?php
                    }
                    ?>
            ...
            <div class="page-sidebar navbar-collapse collapse"> 
                ...
                <ul class="page-sidebar-menu accordion" id="accordion">
                    ...
                    <li class="sidebar-toggler-wrapper charcol-clr">
                        ...
                        {
                        ?>
                        <a href="<?php echo SITE_URL.'Logout.php';?>" class="red"><i class="fa fa-power-off"></i> Sign Out</a>
                        <?php
                        }
                        ?>
                    ...
                    foreach ($reourceItems as $item) {
                        if (is_null($item['parent_id'])) {
                            ...
                            if($item['pk_id'] == 467 ){ // id of ECR menu
                                if((  $_SESSION['user_role'] ==2  && $_SESSION['user_province1'] !=2 )){
                                    continue;
                                    ////// temp check to enable ECR module for PWD SINDH ONLY at the moment
                                }
                            }
                            $class = (basename($item['resource_name']) == basename($_SERVER['PHP_SELF'])) ? 'class="active"' : '';
                            if (strpos($item['resource_name'], '.php') == true) {
